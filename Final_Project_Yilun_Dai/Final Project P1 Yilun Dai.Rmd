...
```
 ...
 Given x_i, generate Y_{i} ~ p(y|x_{i})
 ...
 acceptance probability = \frac{t(p(x_{i}))}{t(x_{i})} \* correction
 
 where correction = \frac{\phi(x_{i}, c \* p(x_{i}), c \* (1-p(x_{i}))}{\phi(p(x_{i}), c \* p(x_{i}), c \* (1-p(x_{i}))}
